...
async function createManyToManyData (products) {
  try {
    ...
    products.forEach(async ({ developer, publisher, genres, supportedOperatingSystems }) => {
      genres && genres.forEach(item => categories[item] = true)
      supportedOperatingSystems && supportedOperatingSystems.forEach(item => platforms[item] = true)
    ...
    console.error('createManyToManyData -> ', error)
  }
...
async function createGames (products) {
  try {
    ...
    console.error('createGames --> ', error)
  }
}
